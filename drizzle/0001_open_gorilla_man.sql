...
CREATE TABLE `__new_CustomFieldEntry` (
	...
	`createdAt` integer DEFAULT '"2024-12-03T17:18:10.368Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2024-12-03T17:18:10.368Z"' NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_CustomField`("id", "createdAt", "updatedAt", "id_name", "data_type", "label", "ai_description", "description", "is_disabled") SELECT "id", "createdAt", "updatedAt", "id_name", "data_type", "label", "ai_description", "description", "is_disabled" FROM `CustomField`;--> statement-breakpoint
...
CREATE TABLE `__new_Entry` (
	`id` integer PRIMARY KEY NOT NULL,
	`createdAt` integer DEFAULT '"2024-12-03T17:18:10.367Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2024-12-03T17:18:10.367Z"' NOT NULL,
